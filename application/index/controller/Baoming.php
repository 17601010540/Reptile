...
class Baoming 
{
	public function List(){
		...
		$result = Db::connect('horseracing_hk')->table('horse_eventlist')->select();
		$arr = array();
		$arr1 = array();
		$arr2 = array();
	...
	public function content(){
		...
		$result = Db::connect('horseracing_hk')->table('horse_event')->where("eventlistFK = $courseId")->select();
		$arr  = array();
		$arr1 = array();
		...
		foreach ($result as $key => $value) {
			...
			$result1 = Db::connect('horseracing_hk')->table('horse_participant')->where("event_keyFK = $key and reserve = 1")->select();
